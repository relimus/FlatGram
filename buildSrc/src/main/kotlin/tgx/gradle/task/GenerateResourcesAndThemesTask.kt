...
open class GenerateResourcesAndThemesTask : BaseTask() {
  ...
  fun generateResourcesAndThemes () {
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/core/LangUtils.kt") { kt ->
      kt.append("@file:JvmName(\"LangUtils\")\n\n")
        .append("package io.relimus.flatgram.core\n\n")
        .append("import androidx.annotation.StringRes\n")
        .append("import me.vkryl.annotation.Autogenerated\n")
        .append("import io.relimus.flatgram.theme.ColorId\n")
        .append("import io.relimus.flatgram.theme.PropertyId\n")

      kt.append("import io.relimus.flatgram.R\n\n")
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/ThemeId.java") { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/PropertyId.java") { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/ColorId.java") { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/ColorIdTinted.java") { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/PorterDuffColorId.java") { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/FallbackColorId.kt") { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/tool/PorterDuffPaint.kt") { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/ThemeProperties.kt") { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/ThemeColors.kt") { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/theme/builtin/ThemeBubbleOverride.kt") { kt ->
      kt.append("""
    ...
    for (entry in themesMap) {
      ...
      writeToFile("app/src/main/java/io/relimus/flatgram/theme/builtin/Theme${className}.kt") { writer ->
        writer.append("""
