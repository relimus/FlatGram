...
open class CheckEmojiKeyboardTask : BaseTask() {
  ...
  fun checkEmojiKeyboard () {
    val supportedFile = File("app/src/main/java/io/relimus/flatgram/tool/EmojiCode.java").readText()
    val displayingFile = File("app/src/main/java/io/relimus/flatgram/tool/EmojiCodeColored.java").readText()
    ...
    writeToFile("app/src/main/java/io/relimus/flatgram/tool/Emojis.kt") { kt ->
      kt.append("""
        @file:JvmName("Emojis")
    ...
    for (i in 0 .. 1) {
      ...
      writeToFile("app/src/main/java/io/relimus/flatgram/tool/EmojiBidi${legacySuffix}.kt") { kt ->
        kt.append("""
