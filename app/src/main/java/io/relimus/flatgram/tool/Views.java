...
import io.relimus.flatgram.support.ViewTranslator;
...
import io.relimus.flatgram.util.WebViewHolder;
...
public class Views {
  ...
  public static View simpleProgressView (Context context, ViewGroup.LayoutParams params) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      io.relimus.flatgram.widget.SpinnerView spinnerView = new io.relimus.flatgram.widget.SpinnerView(context);
