...
import io.relimus.flatgram.loader.gif.LottieCache;
...
import io.relimus.flatgram.sync.TemporaryNotification;
import io.relimus.flatgram.telegram.AccountSwitchReason;
import io.relimus.flatgram.telegram.GlobalAccountListener;
import io.relimus.flatgram.telegram.GlobalCountersListener;
import io.relimus.flatgram.telegram.GlobalResolvableProblemListener;
import io.relimus.flatgram.telegram.LiveLocationManager;
import io.relimus.flatgram.telegram.Tdlib;
import io.relimus.flatgram.telegram.TdlibAccount;
import io.relimus.flatgram.telegram.TdlibBadgeCounter;
import io.relimus.flatgram.telegram.TdlibContext;
...
import io.relimus.flatgram.ui.CallController;
import io.relimus.flatgram.ui.CreateChannelController;
import io.relimus.flatgram.ui.CreateGroupController;
import io.relimus.flatgram.ui.EditChatFolderController;
import io.relimus.flatgram.ui.EditChatFolderInviteLinkController;
import io.relimus.flatgram.ui.EditNameController;
import io.relimus.flatgram.ui.IntroController;
...
import io.relimus.flatgram.ui.PlaybackController;
import io.relimus.flatgram.ui.PrivacyExceptionController;
import io.relimus.flatgram.ui.ProfileController;
import io.relimus.flatgram.ui.SettingsAdapter;
import io.relimus.flatgram.ui.SettingsBugController;
...
import io.relimus.flatgram.ui.SettingsNetworkStatsController;
...
import io.relimus.flatgram.ui.WaitForPremiumController;
import io.relimus.flatgram.unsorted.Settings;
import io.relimus.flatgram.util.Crash;
import io.relimus.flatgram.widget.GearView;
...
public class MainActivity extends BaseActivity implements GlobalAccountListener, GlobalCountersListener, GlobalResolvableProblemListener {
  ...
  private static ViewController<?> restoreController (BaseActivity context, Tdlib tdlib, int id, Bundle in, String keyPrefix) {
    ...
    } else if (id == R.id.controller_flatGramSettings) {
