...
import io.relimus.flatgram.data.TGStickerSetInfo;
...
import io.relimus.flatgram.telegram.GlobalTokenStateListener;
import io.relimus.flatgram.telegram.SessionListener;
import io.relimus.flatgram.telegram.StickersListener;
...
import io.relimus.flatgram.util.PullRequest;
...
public class SettingsController extends ViewController<Void> implements
  ...
  private void showBuildOptions (boolean allowDebug) {
    ...
    b.append(Strings.buildMarkdown(this, Lang.getStringImpl(
      null, R.string.AppSignature, false, 0, null, BuildConfig.VERSION_NAME
    ).toString(), null));
