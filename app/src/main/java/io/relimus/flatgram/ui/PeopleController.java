...
public class PeopleController extends RecyclerViewController<PeopleController.Args> implements View.OnClickListener, Client.ResultHandler, TdlibCache.UserDataChangeListener, TdlibCache.UserStatusChangeListener, io.relimus.flatgram.navigation.Menu, TdlibContactManager.Listener {
